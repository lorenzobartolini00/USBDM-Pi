...
//
#define HW_CAPABILITY     (CAP_VDDCONTROL|CAP_BDM|CAP_FLASH|CAP_CORE_REGS)//(CAP_VDDCONTROL|CAP_CDC|CAP_BDM|CAP_FLASH|CAP_CORE_REGS)
#define TARGET_CAPABILITY (CAP_VDDCONTROL|CAP_RS08|CAP_HCS08)//(CAP_VDDCONTROL|CAP_CDC|CAP_RS08|CAP_HCS08)
